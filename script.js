let arr=["https://rb.gy/bryn2z","https://rb.gy/9m42ic","https://rb.gy/0htbae","https://rb.gy/sfyj6p","dance1.gif","shaqcat.gif","dissapointed.gif","dance2.gif"];
arr=[...arr, ...arr];
let moves=30;
let matches=0;
let gameActive=true;
...
for(let i=1; i<=16; i++){
    ...
    back.innerHTML="<img class='image' src="+arr[rand]+"></img>";
    arr.splice(rand, 1);
